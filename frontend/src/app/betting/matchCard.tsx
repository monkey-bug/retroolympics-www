...
export default function MatchCard(data: any) {
    ...
    const [otherStyleVar, setOtherStyleVar] = useState({
        width: 100 - startingWidth + "%",
    });
    function addPercent() {
    ...
    return (
        <div className="my-2 rounded-md border-2 border-amber-600">
            ...
            <div className="w-full">
                <div
                    className="float-left mx-0 my-2 h-4 bg-green-500 px-0"
                    style={styleVar}
                ></div>
                <div
                    className="float-right mx-0 my-2 h-4 bg-red-500 px-0"
                    style={otherStyleVar}
                ></div>
            </div>
            ...
            <div className="flex w-full">
                <button
                    onClick={addPercent}
                    className="mx-2 rounded-md border-4 border-gray-400 bg-gray-200"
                >
                    add 5%
                </button>
                <button
                    onClick={removePercent}
                    className="mx-2 rounded-md border-4 border-gray-400 bg-gray-200"
                >
                    remove 5%
                </button>
